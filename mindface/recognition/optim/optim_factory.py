...
def create_optimizer(
    ...
    Args:
        ...
        opt(String): Optimizer name like 'sgd', 'nesterov', 'momentum', 'adam', 'adamw',
        ...
        lr(Float): Learning rate: float or lr scheduler.
        ...
        nesterov(Bool): Whether to use Nesterov Accelerated Gradient (NAG) algorithm to
                        update the gradients.
                        Default: False.
        filter_bias_and_bn(Bool): Whether to filter batch norm paramters and bias from weight decay.
                                  If True, weight decay will not apply on BN parameters and bias
                                  in Conv or Dense layers.
                                  Default: True.
        loss_scale(Float): A floating point value for the loss scale,
                           which must be larger than 0.0. Default: 1.0.
