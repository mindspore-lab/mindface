...
from backbone_head import iresnet100, get_mbf, get_mbf_large
...
def val(args):
    ...
    for i in range(length):
        acc1, std1, acc2, std2, xnorm, _ = test(ver_list[i], model, args.batch_size, args.nfolds)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_url', default="/cache/ArcFace--25_11372.ckpt", type=str, help='ckpt path')
